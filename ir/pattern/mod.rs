                ...
                let mode = if let Some(parent_mode) = parent_modes.0.get(&var).copied() {
                    match (parent_mode, mode) {
                        ...
                        (PatternVariableMode::Binding(o1), BindingMode::AlwaysBinding(o2)) => {
                            let o = match (o1, o2) {
                                (VariableOptionality::Optional, _) | (_, BindingOptionality::MaybeNone) => {
                                    VariableOptionality::Optional
                                }
                                (VariableOptionality::Required, BindingOptionality::NotNone) => {
...
impl From<VariableOptionality> for BindingOptionality {
...
impl Into<VariableOptionality> for BindingOptionality {
...
pub(super) enum BindingMode {
    RequirePrebound,
    AlwaysBinding(BindingOptionality),
