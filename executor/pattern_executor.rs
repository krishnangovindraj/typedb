...
use crate::{
    ...
    read::recursive_executor::RecursiveQueryExecutor,
    row::MaybeOwnedRow,
    ExecutionInterrupt,
};

pub struct MatchExecutor {
    recursive_query_executor: RecursiveQueryExecutor,
}
...
impl MatchExecutor {
    pub fn new(
        ...
        RecursiveQueryExecutor::new(match_executable, snapshot, thing_manager, input)
