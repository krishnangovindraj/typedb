...
#[tokio::test]
async fn test_http_driver_http() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour+/driver/http/http.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/driver/http/http.feature";
