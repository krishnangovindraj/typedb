...
async fn test_write_inputs() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour+/query/language/inputs.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/language/inputs.feature";
