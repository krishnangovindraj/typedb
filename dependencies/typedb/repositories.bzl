...
def typedb_protocol():
    git_repository(
        ...
        commit = "90e977e8f033830f22609a557c9a3eb6a6c59c61",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_protocol
    )
...
def typedb_behaviour():
    git_repository(
        ...
        commit = "4eb7b36d4f0b5c91d7d59f4fd5bc708a426ccb3d",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
